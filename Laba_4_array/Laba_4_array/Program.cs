...
namespace Laba_4_array
{
    internal class Program
    {
        ...
        {//Исправил код, путём проверки равенства кол-во мин и макс элементов. И если кол-во равны просто меняем значения, в случае не равенста, Оставляем замену первых встречающихся элементов 
